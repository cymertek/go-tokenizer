...
const (
	ptrKind   = 22 // reflect.Ptr Kind value
	mapKind   = 21 // reflect.Map Kind value
	arrayKind = 17 // reflect.Array Kind value
	chanKind  = 18 // reflect.Chan Kind value
	sliceKind = 23 // reflect.Slice Kind value
)
...
func IsNil(i interface{}) bool {
	...
	case mapKind, arrayKind, chanKind, sliceKind:
		return reflect.ValueOf(i).IsNil()
	}
