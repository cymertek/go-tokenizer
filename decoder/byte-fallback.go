...
// ByteFallback decodes tokens using byte-level fallback for unknown characters, converting them to hex representations.
...
// NewByteFallback creates a new ByteFallback decoder that converts unknown token IDs to their hex byte representations.
