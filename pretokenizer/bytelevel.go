...
// Note: trailing standalone whitespace is intentionally not matched here — it's handled by the
// normalizer (e.g., BertNormalizer strips leading/trailing spaces before pre-tokenization).
