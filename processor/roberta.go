...
// Note: RobertaProcessing does not currently implement a Serialize method.
// Serialization would require defining an interface contract in this package first;
// this is tracked as a future enhancement rather than a production blocker.
